...
export default function Home() {
  ...
  return (
    <div 
      className="flex flex-col min-h-[100dvh] relative overflow-hidden selection:bg-[#1C1C1C] selection:text-[#F9F8F6] font-sans"
    ...
    >
      ...
      {/* Top Navigation Bar */}
      <header className="absolute top-0 w-full px-6 sm:px-10 py-8 flex justify-end z-50">
      ...
      {/* Central Content */}
      <div className="flex-1 flex flex-col items-center justify-center w-full px-6 sm:px-8 py-12 relative z-10 pt-24 pb-20">
        <AnimatePresence mode="wait">
          {activeTab === 'home' && (
            <motion.div 
              ...
              animate="animate"
              exit="exit"
              className="max-w-5xl w-full text-center flex flex-col items-center justify-center absolute"
            >
              <motion.div 
          ...
          {activeTab === 'about' && (
            <motion.div
              ...
              animate="animate"
              exit="exit"
              className="max-w-4xl w-full flex flex-col justify-center items-center text-center absolute px-6"
            >
              <h2 className="text-[2.5rem] sm:text-[4rem] font-serif tracking-tight mb-8 text-[#1C1C1C]">
                The T&P Club
              </h2>
              <div className="text-[15px] sm:text-[1.1rem] leading-[1.8] sm:leading-[2] font-serif text-[#1C1C1C] opacity-80 max-w-3xl mb-14 text-center">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-12 gap-y-10 text-left w-full max-w-3xl text-[#1C1C1C]">
                <div className="flex flex-col">
                  <span className="font-sans font-semibold uppercase tracking-widest text-[12px] sm:text-[13px] mb-3 opacity-90">Orchestrate</span>
                  <p className="font-serif text-[15px] sm:text-[16px] opacity-70 leading-relaxed">
                    Assist the T&P cell in organizing massive recruitment drives, mock interviews, and training events.
                  </p>
                </div>
                <div className="flex flex-col">
                  <span className="font-sans font-semibold uppercase tracking-widest text-[12px] sm:text-[13px] mb-3 opacity-90">Lead</span>
                  <p className="font-serif text-[15px] sm:text-[16px] opacity-70 leading-relaxed">
                    Cultivate intense managerial, event-organizing, and leadership skills within our ranks.
                  </p>
                </div>
                <div className="flex flex-col">
                  <span className="font-sans font-semibold uppercase tracking-widest text-[12px] sm:text-[13px] mb-3 opacity-90">Connect</span>
                  <p className="font-serif text-[15px] sm:text-[16px] opacity-70 leading-relaxed">
                    Build bridges between current students and our powerful alumni network.
                  </p>
                </div>
                <div className="flex flex-col">
                  <span className="font-sans font-semibold uppercase tracking-widest text-[12px] sm:text-[13px] mb-3 opacity-90">Empower</span>
                  <p className="font-serif text-[15px] sm:text-[16px] opacity-70 leading-relaxed">
      ...
      <motion.div 
        ...
        className="w-full px-6 md:px-10 pt-6 pb-8 md:pb-8 flex flex-col md:flex-row items-center md:justify-between gap-4 text-[12px] sm:text-[13px] font-sans text-[#1C1C1C] opacity-50 hover:opacity-75 transition-opacity duration-300 z-20 shrink-0 absolute bottom-0"
      >
